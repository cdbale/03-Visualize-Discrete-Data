...
- Discrete data are also called *categorical*.
...
Notice that the previous plot no longer has a count on the y-axis - it is a proportion. Let's change the labels.
...
## Pause! How Could We Remove Stop Words?

Remember, we have two data frames. What kind of function could we apply to these data frames to remove rows containing stop words in our data?
